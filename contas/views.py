...
def pagar_conta(request, conta_id):
    ...
    # Atualize o saldo mensal aqui (subtraia o valor da conta do saldo total)
    saldo_mensal = saldo_mensal - conta.valor
    
    # Faça qualquer outra lógica relacionada ao pagamento da conta
    
    # Exclua a conta
    conta.delete()
    
    # Redirecione para a página desejada (pode ser a mesma página ou outra)
